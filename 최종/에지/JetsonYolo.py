...
jetson_location = [36.145589, 128.392442]
...
def Show_gps():
    g_map = folium.Map(location=[36.145589, 128.392442], zoom_start=18)
    marker = folium.Marker(location=[36.145589, 128.392442], popup='Jetson Nano', icon = folium.Icon(color='blue'))
    marker.add_to(g_map)
    g_map.save('gps.html')
    webbrowser.open_new_tab('gps.html')
